...
public class GraphDatabase {
	...
	public static Map<Relationships, String> relacionDosNodosEdges = new HashMap<Relationships, String>(200000);
	...
	public int[] constraintsVertices;
	public int sleepTimeBacktraking;
	 ...
	 */
	public GraphDatabase(String fileName, int[] constraints, int sleepTimeBacktraking) throws IOException {

		this.constraintsVertices = constraints;
		this.sleepTimeBacktraking = sleepTimeBacktraking;
